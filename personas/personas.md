...
- **Estado de datos:** Sin datos reales — basado en audiencia.md y prueba-social.md
...
- **Estado de datos:** Sin datos reales — basado en audiencia.md
...
|---|---|---|---|
| Freelancer colombiano | Colombia | 10% del volumen total | 5+ tickets de soporte o 3+ entrevistas |
